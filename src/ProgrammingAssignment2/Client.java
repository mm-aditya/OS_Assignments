...
public class Client {
    ...
    private void handshake() throws Exception {
        printer.println("HI");
        //byte[] stuff = readAll();
        byte[] stuff = new byte[128];
        in.read(stuff, 0 ,128);
        System.out.println(new String(DatatypeConverter.printBase64Binary(stuff).getBytes()));
        ...
        //System.out.println(Arrays.toString(byteCert).length());
...
//    }
    ...
    private byte[] decryptBytes(byte[] toBeDecrypted) throws Exception {
        ...
        System.out.println("god why" + toBeDecrypted.length);
